...
class FirstForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      ...
      '#description' => $this->t('Kindly fill in this simple personal details form to check for your eligibility to participate in Google-Code in'),
    ];
...
// Approval checkbox
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
        ...
        // check if user meet age requirements
          ...
          $form_state->setErrorByName('age', $this->t('Sorry ,You should be aged 13 and above to participate in Google Code in'));
        ...
        if ($age > 17) {
          ...
          $form_state->setErrorByName('age', $this->t('Sorry , You should be 17 or less to participate in Google Code in'));
